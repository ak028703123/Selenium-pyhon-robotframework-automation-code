...
# with open('C:\\gitrep\\properpay-automation\\PPay_Project\\TestData\\CommonFunctionality_TestData.yaml') as f:
# with open('C:\\GitRepo\\properpay-automation\\PPay_Project\\TestData\\CommonFunctionality_TestData.yaml') as f:
with open('C:\\ProperPayProject\\ProperPay_Automation\\TestData\\UI\\CommonFunctionality\\PPay7_CommonFunctionality_TestData.yaml') as f:
